                        ...
                        <table class="table">
                                <thead id='tablehead'>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><%=m.getMemberPk()%></td>
                                            <td><a href="<%=request.getContextPath() %>/mypageInfoChange.do?memberPk=<%=m.getMemberPk() %>"><%=m.getMemberId()%></a></td>
                                            <td><a href="<%=request.getContextPath() %>/mypageInfoChange.do?memberPk=<%=m.getMemberPk() %>"><%=m.getMemberName()%></a></td>
                                            <td><%if(m.getMemberLevel().equals("1")){%>관리자<%}else if(m.getMemberLevel().equals("2")){ %>점주<%}else{ %>일반 사용자<%} %></td> 
                                        </tr>
                                        <%}} %>
