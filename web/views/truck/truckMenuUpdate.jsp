	...
	$(function() {
		...
		$("#addBtn").click( function() {
							list = $('<li id='
									...
									+ "menu-check-img"
									+ (i + 1)
									+ ' class="menu-check-img" src="http://proxyprivat.com/images/noimage.jpeg" alt="Card image cap" width=100% height=100><br><button class="btn-success menu-img-replace">사진등록</button><div class="test"><input id='
									+ "menu-input-img"
									+ (i + 1)
