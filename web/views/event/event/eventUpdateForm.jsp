                            ...
                            <form class="form-horizontal" action="<%=request.getContextPath()%>/eventUpdateFormEnd.do?eventPk=<%=event.getEventPk()%>" method='post' enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-2">
                                        <input class="form-control" name="eventDate"type="date" required value="<%=event.getEventDate()%>">
                                   	</div>
                                   	<div class="col-sm-1 text-center" >~</div>
 									<div class="col-sm-2">
                                        <input class="form-control" name="eventEndDate" type="date" required value="<%=event.getEventEndDate()%>">
                                   	</div>
                                   </div>
