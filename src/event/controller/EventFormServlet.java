	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//현재 페이지 번호
				...
				if(pageNo==1) {
					...
					pageBar+="<li><a href='"+request.getContextPath()+"/eventForm.do?cPage="+(pageNo-1)+"&numPerPage="+numPerPage+"'><span aria-hidden='true'>«</span></a></li>";
				...
				while(!(pageNo>pageEnd||pageNo>totalPage)) {
					if(cPage==pageNo) {
						...
						pageBar+="<li><a href='"+request.getContextPath()+"/eventForm.do?cPage="+pageNo+"&numPerPage="+numPerPage+"'>"+pageNo+"</a></li>";
					}
					pageNo++;
				}
				...
				if(pageNo>totalPage) {
					...
					pageBar+="<li><a href='"+request.getContextPath()+"/eventForm.do?cPage="+pageNo+"&numPerPage="+numPerPage+"'><span aria-hidden='true'>»</span></a></li>";
				}
