...
/**
 * Servlet implementation class AdminStoreEnrollListServlet
 */
@WebServlet("/adminStoreEnrollList.do")
public class AdminStoreEnrollListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminStoreEnrollListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/views/admin/adminStoreEnroll/adminStoreEnrollList.jsp").forward(request, response);
	}
